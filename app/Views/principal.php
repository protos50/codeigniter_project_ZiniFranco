...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light p-0">
    <div class="container-fluid">
      <a class="navbar-brand" href="/codeigniter_project_ZiniFranco/public/">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item  p-2">
            <a class="nav-link" href="/codeigniter_project_ZiniFranco/public/nosotros">Quienes Somos</a>
          </li>
          <li class="nav-item  p-2">
            <a class="nav-link" href="/codeigniter_project_ZiniFranco/catalogo">Comercialización</a>
          </li>
          </li>
          <li class="nav-item  p-2">
            <a class="nav-link" href="/codeigniter_project_ZiniFranco/contacto">Información de Contacto</a>
          </li>
          <li class="nav-item  p-2">
            <a class="nav-link" href="/codeigniter_project_ZiniFranco/terminos">Términos y Usos</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div id="carouselExampleFade" class="carousel slide carousel-fade">
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        <img src="assets/img/img4.avif" class="d-block w-100 img-fluid" alt="...">
      </div>
    </div>
