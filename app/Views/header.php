    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item  p-2">
            <a class="nav-link" href="/codeigniter_project_ZiniFranco/public/comercializacion">Comercialización</a>
          </li>
          </li>
          <li class="nav-item  p-2">
            <a class="nav-link" href="/codeigniter_project_ZiniFranco/public/contacto">Información de Contacto</a>
          </li>
          <li class="nav-item  p-2">
            <a class="nav-link" href="/codeigniter_project_ZiniFranco/public/terminos">Términos y Usos</a>
          </li>
        </ul>
      </div>
    </div>
